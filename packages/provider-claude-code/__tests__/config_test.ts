...
import { assertClaudeCodeUpstreamRecord } from '../src/config.ts';
...
const wrap = (config: unknown): UpstreamRecord => ({
  ...
  flagOverrides: {}, disabledPublicModelIds: [], proxyFallbackList: [], modelPrefix: null, modelsCache: null, color: null,
});
