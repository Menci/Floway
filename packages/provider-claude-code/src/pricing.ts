...
import { tokenBasePricing, tokenModelPricing, pricingEntry, type ModelPricing, type PriceVector } from '@floway-dev/protocols/common';
...
const SONNET_PRICING = tokenBasePricing({ input: 3, input_cache_read: 0.3, input_cache_write: 3.75, input_cache_write_1h: 6, output: 15 });
// Sonnet 5 introductory pricing runs through 2026-08-31.
const SONNET_5_INTRO_PRICING = tokenBasePricing({ input: 2, input_cache_read: 0.2, input_cache_write: 2.5, input_cache_write_1h: 4, output: 10 });
...
const CLAUDE_CODE_MODEL_PRICING: Record<string, ModelPricing> = {
  ...
  'claude-fable-5': tokenBasePricing({ input: 10, input_cache_read: 1, input_cache_write: 12.5, input_cache_write_1h: 20, output: 50 }),
  'claude-sonnet-4-5-20250929': SONNET_PRICING,
  'claude-opus-4-5-20251101': OPUS_PRICING,
  'claude-haiku-4-5-20251001': tokenBasePricing({ input: 1, input_cache_read: 0.1, input_cache_write: 1.25, input_cache_write_1h: 2, output: 5 }),
  'claude-opus-4-1-20250805': tokenBasePricing({ input: 15, input_cache_read: 1.5, input_cache_write: 18.75, input_cache_write_1h: 30, output: 75 }),
};
