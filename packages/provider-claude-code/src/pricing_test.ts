...
describe('pricingForClaudeCodeModelKey', () => {
  test('returns documented base rates for dated Opus and Fable', () => {
    ...
    expect(resolveEffectivePricing(pricingForClaudeCodeModelKey('claude-fable-5'), null)).toEqual({ input: 10, input_cache_read: 1, input_cache_write: 12.5, input_cache_write_1h: 20, output: 50 });
  });
