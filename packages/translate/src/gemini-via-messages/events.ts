import { flushGeminiThoughtSignature, type GeminiThoughtSignatureState, geminiCandidateEvent, parseStrictJsonObject, signGeminiPart } from '../shared/gemini-via/gemini.ts';
  ...
  for await (const event of upstreamMessagesEventsUntilTerminal(frames)) {
    ...
    case 'content_block_start':
      ...
      if (event.content_block.type === 'redacted_thinking') {
        state.pendingThoughtSignature = event.content_block.data;
        break;
      }
    ...
    case 'content_block_delta':
      ...
      case 'signature_delta':
        state.pendingThoughtSignature = event.delta.signature;
        break;
      case 'text_delta':
