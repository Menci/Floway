...
// every `anthropic-messages-via-*` pair condenses them onto the OpenAI-canonical
...
export const resolveAnthropicMessagesReasoningEffort = (payload: AnthropicMessagesPayload): string | undefined => {
