...
const { withResponsesServerToolShim } = await import('../../../../../../src/data-plane/chat/responses/interceptors/server-tool-shim.ts');
const { imageGenerationServerTool } = await import('../../../../../../src/data-plane/chat/responses/interceptors/server-tools/image-generation.ts');
