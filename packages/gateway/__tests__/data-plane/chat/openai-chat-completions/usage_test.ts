...
test('OpenAI Chat Completions billable usage splits the inclusive prompt total into disjoint buckets', () => {
...
test('OpenAI Chat Completions billable usage forwards a served tier and drops the default', () => {
...
test('OpenAI Chat Completions billable usage reports no cache-write TTL split, which the protocol cannot express', () => {
  expect(billableUsageFromOpenAIChatCompletionsUsage({
