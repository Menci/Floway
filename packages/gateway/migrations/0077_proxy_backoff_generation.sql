...
ALTER TABLE proxy_upstream_backoffs RENAME TO proxy_upstream_backoffs_pre_0077;
...
FROM proxy_upstream_backoffs_pre_0077 b
JOIN proxies p ON p.id = b.proxy_id;

DROP TABLE proxy_upstream_backoffs_pre_0077;
