-- packages/gateway/migrations/0049_perf_ttft_tpot.sql
...
CREATE TABLE performance_summary (
  ...
  PRIMARY KEY (hour, key_id, model, upstream, runtime_location)
);
...
CREATE TABLE performance_buckets (
  ...
  PRIMARY KEY (hour, key_id, model, upstream, runtime_location, metric, lower)
);
