// Default `base_instructions` for synthesized Codex catalog entries —
// i.e., Floway-routed chat models that do not appear in the bundled Codex
// catalog. Adapted from openai/codex `models-manager/models.json`'s
// `gpt-5.5` entry (latest at the time of vendoring) at commit
