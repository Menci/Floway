...
// Claude Code clients seed every Anthropic Messages request with an
...
export const stripBillingAttribution: AnthropicMessagesPayloadInterceptor = (ctx, _gatewayCtx, run) => {
