...
// OpenAI Responses upstreams accept it for prefix-cache attribution, so removal only
// happens under the flag.
export const withPromptCacheKeyStripped: OpenAIResponsesInterceptor = async (ctx, _gatewayCtx, run) => {
