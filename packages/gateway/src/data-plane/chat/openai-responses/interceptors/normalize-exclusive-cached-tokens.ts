// OpenAI-Responses-shape counterpart of the OpenAI Chat Completions normalizer of the same
// name. The evidence for the two conventions, the decision rule, and the two
// contradictions that raise are documented once, at
// `../../openai-chat-completions/interceptors/normalize-exclusive-cached-tokens.ts`
// and at `foldsExclusiveCacheTokens`.
//
// OpenAI Responses carries usage on `event.response.usage` and names the buckets
