...
import { imagesRequestWantsStream, parseImagesEditsRequest, parseImagesGenerationsRequest, type ParsedImagesRequest } from '@floway-dev/protocols/images';
...
const serveImages = async (
  ...
  // from this flag.
  const wantsStream = imagesRequestWantsStream(request);
