 ...
 * whatever shapes the frames and inside whatever frames them for a transport. Reading is what
 * records: a losing attempt nobody read contributes nothing, because the release path drains
 * the stream underneath this rather than through it.
 *
