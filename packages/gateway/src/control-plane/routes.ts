...
import { getCodexUltraConfigRoute, putCodexUltraConfigRoute } from './codex-ultra-config/routes.ts';
...
export const controlPlaneRoutes = new Hono<{ Variables: AuthVars }>()
  ...
  .route('/api', new Hono<{ Variables: AuthVars }>()
    ...
    .get('/codex-ultra-config', getCodexUltraConfigRoute)
    .put('/codex-ultra-config', zValidator('json', codexUltraConfigSchema), putCodexUltraConfigRoute)
