 ...
 *     value was already consumed by `callAnthropicMessages` to pick the raw variant
 ...
 */
export const withSpeedFast: CopilotAnthropicMessagesBoundaryInterceptor = async (ctx, _env, run) => {
