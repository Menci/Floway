 ...
 * Copilot Chat re-tags the native Anthropic Messages upstream call with a different
 ...
 * a native Anthropic Messages target and both halves of the Claude Code
