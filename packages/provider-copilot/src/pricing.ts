...
import { tokenBasePricing, tokenModelPricing, pricingEntry, type ModelPricing } from '@floway-dev/protocols/common';

type PricingRule = readonly [key: string | RegExp, pricing: ModelPricing];

const COPILOT_MODEL_PRICING: readonly PricingRule[] = [
  ['claude-opus-4-5', tokenBasePricing({ input: 5, input_cache_read: 0.5, input_cache_write: 6.25, output: 25 })],
  ...
  ['claude-sonnet-5', tokenBasePricing({ input: 2, input_cache_read: 0.2, input_cache_write: 2.5, output: 10 })],
  [/^claude-sonnet-4(-[56])?$/, tokenBasePricing({ input: 3, input_cache_read: 0.3, input_cache_write: 3.75, output: 15 })],
  ['claude-haiku-4-5', tokenBasePricing({ input: 1, input_cache_read: 0.1, input_cache_write: 1.25, output: 5 })],
  ...
  ['gpt-5.4-mini', tokenBasePricing({ input: 0.75, input_cache_read: 0.075, output: 4.5 })],
  ['gpt-5.4-nano', tokenBasePricing({ input: 0.2, input_cache_read: 0.02, output: 1.25 })],
  [/^gpt-5[.][23](-codex)?$/, tokenBasePricing({ input: 1.75, input_cache_read: 0.175, output: 14 })],
  ['gpt-5.1-codex-mini', tokenBasePricing({ input: 0.25, input_cache_read: 0.025, output: 2 })],
  [/^gpt-5[.]1/, tokenBasePricing({ input: 1.25, input_cache_read: 0.125, output: 10 })],
  ['gpt-5-mini', tokenBasePricing({ input: 0.25, input_cache_read: 0.025, output: 2 })],
  [/^gpt-4[.]1/, tokenBasePricing({ input: 2, input_cache_read: 0.5, output: 8 })],
  ['gpt-41-copilot', tokenBasePricing({ input: 2, input_cache_read: 0.5, output: 8 })],
  [/^gpt-4o(-[0-9]{4}-[0-9]{2}-[0-9]{2})?$/, tokenBasePricing({ input: 2.5, input_cache_read: 1.25, output: 10 })],
  ['gpt-4-o-preview', tokenBasePricing({ input: 2.5, input_cache_read: 1.25, output: 10 })],
  [/^gpt-4o-mini/, tokenBasePricing({ input: 0.15, input_cache_read: 0.075, output: 0.6 })],
  [/^gpt-4(-0613)?$/, tokenBasePricing({ input: 30, output: 60 })],
  ['gpt-4-0125-preview', tokenBasePricing({ input: 10, output: 30 })],
  ['gpt-3.5-turbo', tokenBasePricing({ input: 0.5, output: 1.5 })],
  ['gpt-3.5-turbo-0613', tokenBasePricing({ input: 1.5, output: 2 })],
  ...
  ['gemini-2.5-pro', tokenBasePricing({ input: 1.25, input_cache_read: 0.125, output: 10 })],
  ['gemini-3-flash-preview', tokenBasePricing({ input: 0.5, input_cache_read: 0.05, output: 3 })],
  ...
  ['gemini-3.5-flash', tokenBasePricing({ input: 1.5, input_cache_read: 0.15, output: 9 })],
  [/^grok-code-fast/, tokenBasePricing({ input: 0.2, output: 1.5 })],
  ['goldeneye', tokenBasePricing({ input: 1.25, input_cache_read: 0.125, output: 10 })],
  ['raptor-mini', tokenBasePricing({ input: 0.25, input_cache_read: 0.025, output: 2 })],
  ['minimax-m2.5', tokenBasePricing({ input: 0.3, output: 1.2 })],
  [/^mai-code-1-flash/, tokenBasePricing({ input: 0.75, input_cache_read: 0.075, output: 4.5 })],
  [/^text-embedding-3-small/, tokenBasePricing({ input: 0.02, output: 0 })],
  ['text-embedding-ada-002', tokenBasePricing({ input: 0.1, output: 0 })],
];
