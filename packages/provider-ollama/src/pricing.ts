...
const OLLAMA_MODEL_PRICING: readonly PricingRule[] = [
  ...
  ['gpt-oss:120b', tokenBasePricing({ input: 0.15, input_cache_read: 0.075, output: 0.6 })],
  ['gpt-oss:20b', tokenBasePricing({ input: 0.075, input_cache_read: 0.0375, output: 0.3 })],
  ...
  ['qwen3-coder:480b', tokenBasePricing({ input: 0.3, output: 1.0 })],
  ...
  ['qwen3-coder-next', tokenBasePricing({ input: 0.3, output: 1.5 })],
  ...
  ['qwen3.5:397b', tokenBasePricing({ input: 0.6, output: 3.6 })],
  ...
  ['deepseek-v3.1:671b', tokenBasePricing({ input: 0.56, input_cache_read: 0.07, output: 1.68 })],
  ['deepseek-v3.2', tokenBasePricing({ input: 0.28, input_cache_read: 0.028, output: 0.42 })],
  ['deepseek-v4-pro', tokenBasePricing({ input: 0.435, input_cache_read: 0.003625, output: 0.87 })],
  ['deepseek-v4-flash', tokenBasePricing({ input: 0.14, input_cache_read: 0.0028, output: 0.28 })],
  ...
  ['glm-4.7', tokenBasePricing({ input: 0.6, input_cache_read: 0.11, output: 2.2 })],

  // GLM 5.x — Z.ai first-party. Bare `glm-5` is cheaper than `glm-5.1`
  // and `glm-5.2`, so they need separate rules.
  // https://docs.z.ai/guides/overview/pricing
  ['glm-5', tokenBasePricing({ input: 1.0, input_cache_read: 0.2, output: 3.2 })],
  [/^glm-5\.[12]$/, tokenBasePricing({ input: 1.4, input_cache_read: 0.26, output: 4.4 })],
  ...
  ['kimi-k2.5', tokenBasePricing({ input: 0.55, input_cache_read: 0.1, output: 2.9 })],
  ['kimi-k2.6', tokenBasePricing({ input: 0.95, input_cache_read: 0.16, output: 4.0 })],
  ['kimi-k2.7-code', tokenBasePricing({ input: 0.95, input_cache_read: 0.19, output: 4.0 })],
  ...
  [/^minimax-m2(\.[15])?$/, tokenBasePricing({ input: 0.3, input_cache_read: 0.03, output: 1.2 })],
  ['minimax-m2.7', tokenBasePricing({ input: 0.3, input_cache_read: 0.06, output: 1.2 })],
  ...
  ['mistral-large-3:675b', tokenBasePricing({ input: 0.5, output: 1.5 })],
  ['devstral-2:123b', tokenBasePricing({ input: 0.4, input_cache_read: 0.04, output: 2.0 })],
  ...
  ['ministral-3:3b', tokenBasePricing({ input: 0.1, input_cache_read: 0.01, output: 0.1 })],
  ['ministral-3:8b', tokenBasePricing({ input: 0.15, input_cache_read: 0.015, output: 0.15 })],
  ['ministral-3:14b', tokenBasePricing({ input: 0.2, input_cache_read: 0.02, output: 0.2 })],
  ...
  ['nemotron-3-nano:30b', tokenBasePricing({ input: 0.05, output: 0.2 })],
  ['nemotron-3-super', tokenBasePricing({ input: 0.1, output: 0.5 })],
  ['nemotron-3-ultra', tokenBasePricing({ input: 0.5, input_cache_read: 0.1, output: 2.2 })],
  ...
  ['rnj-1:8b', tokenBasePricing({ input: 0.15, output: 0.15 })],

  // Gemini 3 Flash (preview) — Google AI Studio.
  // https://ai.google.dev/gemini-api/docs/pricing
  ['gemini-3-flash-preview', tokenBasePricing({ input: 0.5, input_cache_read: 0.05, output: 3.0 })],
