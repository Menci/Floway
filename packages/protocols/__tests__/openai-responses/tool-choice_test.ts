...
import type { OpenAIResponsesTool, OpenAIResponsesToolChoice } from '../../src/openai-responses/index.ts';
...
] as const satisfies ReadonlyArray<{ tool: OpenAIResponsesTool; choice: OpenAIResponsesToolChoice }>;
