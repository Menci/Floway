...
export type BillingMetric = 'input_tokens' | 'input_cache_read_tokens' | 'input_cache_write_tokens' | 'input_cache_write_1h_tokens' | 'input_image_tokens' | 'input_audio_tokens' | 'input_audio_seconds' | 'output_tokens' | 'output_image_tokens';

// Iteration form of BillingMetric; the type union is the source of truth.
export const BILLING_METRICS: readonly BillingMetric[] = ['input_tokens', 'input_cache_read_tokens', 'input_cache_write_tokens', 'input_cache_write_1h_tokens', 'input_image_tokens', 'input_audio_tokens', 'input_audio_seconds', 'output_tokens', 'output_image_tokens'];
...
export interface PublicModel {
  ...
  // `imagesGenerations`, `imagesEdits`, and `audioTranscriptions` only appear when the upstream
