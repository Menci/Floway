...
// WinUI ships no chart control, so it states no legend or callout swatch; 10px
// is ours, taken under Fluent's own 12px swatch, which reads heavy beside the
// 11-12px text it stands next to.
