...
<template>
  <div :class="framed && 'glass-card p-5 sm:p-6 animate-in delay-2'">
    ...
    <p class="text-sm text-gray-400 mb-4">Download API keys, affinity secrets, upstreams, proxies, web search config, and usage data as a JSON file. Treat the file like a database backup.</p>
