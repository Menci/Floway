...
//
// The padding is an optical compensation, not spacing. The monospace face's
// ascent and descent are not symmetric about its cap band, so centring the line
// box leaves the glyph 0.75px high -- measured at 2x, 14 rows of gap above the
// ink and 17 below in a 24px badge. Padding on one side moves centred content by
// half of itself, so 1.5px buys the 0.75px. This is the only place the app
// centres the monospace face in a fixed-height box; everywhere else it sets
// running text.
