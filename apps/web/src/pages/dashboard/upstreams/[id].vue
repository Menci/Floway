...
// mount pre-populated. The model catalog is fetched on demand by the editor;
// the Copilot quota snapshot rides along on the record, and the editor only
// re-reads it when the operator asks for a refresh.
