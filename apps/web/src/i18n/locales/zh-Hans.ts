  ...
  translation: {
    ...
    dashboard: {
      ...
      playground: {
        ...
        responsesLiteHint: '使用 Codex Responses Lite，保留工具名称、命名空间和图片引用；支持的工具及图片格式取决于上游模型。',
      ...
      upstreamEditor: {
        ...
        models: {
          ...
          endpoints: '支持的 API',
          responsesTransport: 'OpenAI Responses 传输方式',
          responsesStandard: '标准 Responses',
          responsesLite: 'Responses Lite',
          responsesTransportHint: '上游模型支持 Responses Lite 时请选择此项，其他模型请保持标准 Responses。',
          capabilities: '能力与限制',
          contextWindow: '上下文窗口',
