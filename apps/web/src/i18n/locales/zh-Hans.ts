  ...
  translation: {
    ...
    dashboard: {
      ...
      modelAliases: {
        ...
        target: { heading: '模型', description: '使用“首个可用”时将按顺序尝试目标。可选择建议或输入任意模型 ID。', label: '目标 {{number, number}}', modelId: '目标模型 ID', placeholder: '目标模型 ID', toggle: '展开目标规则', enabled: '启用目标路由', moveUp: '上移目标', moveDown: '下移目标', remove: '移除目标', count_other: '{{count, number}} 个目标' },
