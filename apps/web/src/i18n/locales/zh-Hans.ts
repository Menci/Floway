    ...
    dashboard: {
      ...
      apiKeys: {
        ...
        form: {
          ...
          openaiResponsesRetention: 'Stateful Responses 保留',
          openaiResponsesRetentionHint: '该 API 密钥的 Responses 条目可被后续请求按 id 引用的时长（关闭表示不做持久化）',
          retentionHint:
        ...
        retention: {
          ...
          openaiResponsesWarningDisable: '保存后会删除该 API 密钥已存储的 Responses 条目。后续请求按 id 引用时将无法找到。',
          openaiResponsesWarningShrink: '保存后会删除超过新窗口的 Responses 条目。后续请求按 id 引用时将无法找到。',
        },
        configuration: {
          title: '配置你的 Agent',
      ...
      upstreamEditor: {
        ...
        headers: {
          ...
          validation: {
            ...
            anthropicMessagesOwned: '此标头由 Messages 协议管理。',
