    ...
    dashboard: {
      ...
      oauth2: {
        ...
        form: {
          ...
          accessPolicyHint: '可选 JSON，将对 UserInfo 响应求值。contains 要求点分路径指定的 Claim 是数组，且数组包含完全相同的字符串。留空表示允许所有已认证用户。',
        ...
        validation: {
          ...
          accessPolicyShape: '请使用 logic（and/or）和 conditions；每项包含 field、op（contains）以及字符串 value。',
        },
        toast: {
