  ...
  translation: {
    ...
    dashboard: {
      ...
      searchConfig: {
        ...
        providerDescMicrosoftWebIq: 'Microsoft Web IQ 提供面向 AI agent 的网络搜索与网页抓取 API。',
