    ...
    dashboard: {
      ...
      upstreamEditor: {
        ...
        models: {
          ...
          opaqueBlobCompatibility: '不透明数据兼容性',
          opaqueBlobCompatibilityHint: '兼容性标识相同的模型可以相互复用不透明数据。',
          bindOpaqueBlobsToUpstream: '将兼容性绑定到当前上游',
          bindOpaqueBlobsToUpstreamHint: '选中后，该模型产生的不透明数据路由到其他上游时，即使兼容性 Key 相同也不被视为兼容。',
          opaqueBlobCompatibilityKey: '兼容性 Key',
          opaqueBlobCompatibilityKeyHint: '该模型产生的不透明数据路由到兼容性 Key 不同的模型时，将被视为不兼容，并被丢弃或拒绝。',
          endpoints: '支持的 API',
          capabilities: '能力与限制',
          contextWindow: '上下文窗口',
