  ...
  translation: {
    ...
    dashboard: {
      ...
      modelAliases: {
        ...
        metadata: { heading: '手动声明元数据', description: '/v1/models 为此别名报告的能力', manual: '手动声明元数据', limits: 'Token 限制', context: '上下文窗口', prompt: '提示 token', output: '输出 token', imageInput: '图像输入', imageDetailOriginal: '原始图像细节', reasoning: '思考', effortEnabled: '强度级别', budgetEnabled: '预算 token', adaptive: '自适应', mandatory: '强制思考', efforts: '支持的强度', effortsHint: '使用逗号分隔；保留顺序。', defaultEffort: '默认强度', minBudget: '最小预算', maxBudget: '最大预算' },
