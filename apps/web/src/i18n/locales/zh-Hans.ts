  ...
  translation: {
    ...
    dashboard: {
      ...
      playground: {
        ...
        badges: {
          ...
          rules: {
            ...
            reasoningBudget: '思考预算：<strong>{{value}}</strong> token',
            adaptive: '自适应思考',
            nonAdaptive: '非自适应思考',
      ...
      modelAliases: {
        ...
        validation: { nameRequired: '请输入别名 ID。', duplicate: '已存在使用此 ID 的别名。', targetRequired: '请输入目标模型 ID。', targetsRequired: '请至少添加一个目标模型。', budget: '思考预算必须是非负整数。', adaptiveBudget: '自适应思考不能与固定预算同时使用。', metadataNumber: '请输入 0 或更大的整数 token 数。', metadataRange: '最大预算必须大于或等于最小预算。' },
