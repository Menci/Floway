    ...
    dashboard: {
      ...
      oauth2: {
        ...
        form: {
          ...
          accessPolicy: '允许登录的用户',
          accessPolicyHint: 'OAuth2 身份认证完成后，再向上游检查组织或团队成员资格。',
          giteaBaseUrl: 'Gitea Base URL',
          giteaBaseUrlHint: '填写要查询组织 API 的 Gitea 实例根地址。',
          giteaAllowedMemberships: '允许的 Gitea 组织和团队',
          giteaAllowedMembershipsHint: '每行一项。填写 organization 表示允许任意组织成员；填写 organization:team 表示仅允许指定团队。任意一项匹配即可登录。',
          scopes: 'Scopes',
          scopesHint: '使用空格分隔 OAuth2 scope，例如：openid profile email',
        ...
        accessPolicy: {
          allow_all: '所有已通过 OAuth2 认证的用户',
          gitea: '指定的 Gitea 组织或团队',
        },
        validation: {
          required: '此字段为必填项。',
          ...
          giteaBaseUrl: '请输入不含凭据、查询或片段的 Gitea HTTP 或 HTTPS Base URL。',
          giteaMembership: '每行请填写 organization 或 organization:team。',
          giteaScopes: 'Gitea 准入检查需要 read:user 和 read:organization scope。',
        },
        toast: {
