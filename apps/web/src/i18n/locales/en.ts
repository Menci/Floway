    ...
    dashboard: {
      ...
      oauth2: {
        ...
        form: {
          ...
          accessPolicy: 'Who can sign in',
          accessPolicyHint: 'Apply an upstream membership check after OAuth2 authentication.',
          giteaBaseUrl: 'Gitea Base URL',
          giteaBaseUrlHint: 'The root URL of the Gitea instance whose organization API will be queried.',
          giteaAllowedMemberships: 'Allowed Gitea organizations and teams',
          giteaAllowedMembershipsHint: 'One per line. Use organization for any member, or organization:team for a specific team. Any matching entry grants access.',
          scopes: 'Scopes',
          scopesHint: 'Space-separated OAuth2 scopes, for example: openid profile email',
        ...
        accessPolicy: {
          allow_all: 'Every authenticated OAuth2 user',
          gitea: 'Selected Gitea organizations or teams',
        },
        validation: {
          ...
          giteaBaseUrl: 'Enter a Gitea HTTP or HTTPS Base URL without credentials, a query, or a fragment.',
          giteaMembership: 'Use organization or organization:team on each line.',
          giteaScopes: 'Gitea access checks require the read:user and read:organization scopes.',
        },
        toast: {
