      ...
      upstreamEditor: {
        ...
        codex: {
          ...
          resetCards: {
            ...
            status: { available: 'Available', expired: 'Expired', redeemed: 'Redeemed' },
            ...
            refreshWarning: 'The card was processed, but Floway could not refresh all local details: {{error}}',
            result: {
