  ...
  translation: {
    ...
    dashboard: {
      ...
      upstreamEditor: {
        ...
        codex: {
          ...
          resetCards: {
            ...
            refresh: 'Refresh reset cards',
            defaultTitle: 'Codex rate-limit reset',
            granted: 'Granted {{time}}',
            expires: 'Expires {{time}}',
            ...
            confirmMessage: 'Use “{{title}}” now? This resets the eligible Codex rate-limit windows and cannot be undone.',
            refreshWarning: 'The card was processed, but Floway could not refresh all details. Refresh reset cards to check their current state.',
            loadError: 'Could not load reset cards. Try refreshing again.',
            redeemError: 'Could not confirm the reset. Retry to check the same redemption safely.',
            result: {
              reset: 'The Codex rate-limit windows were reset.',
              alreadyRedeemed: 'This request was already redeemed; no second card was consumed.',
              nothingToReset: 'There are currently no eligible rate-limit windows to reset.',
              noCredit: 'This reset card is no longer available.',
              unknown: 'OpenAI returned an unfamiliar reset result: {{code}}',
            },
          },
          import: {
            tabJson: 'Paste JSON',
      ...
      requests: {
        ...
        collapseEvents: 'Collapse all events',
        expandEvents: 'Expand all events',
        noEventMatches: 'No matching events',
        events: 'Events ({{count, number}})',
        headers: 'Headers ({{count}})',
        raw: 'Raw bytes',
        base64: 'Raw bytes (Base64)',
        partialCapture: 'Capture ended before EOF. These are the bytes received so far.',
        ...
        search: 'Search ID, model, path, upstream, status or error',
        failuresOnly: 'Failures only',
        applyFilters: 'Search history',
        selectExport: 'Select for export',
        exportCombined: 'Combined JSON',
        exportSeparate: 'Separate files (.tar)',
        selectLoaded: 'Select loaded records',
        clearSelection: 'Clear selection',
        exportSelection: 'Export {{count}} selected',
        exportFailed: 'Could not export the selected records.',
