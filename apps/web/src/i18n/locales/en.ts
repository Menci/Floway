  ...
  translation: {
    ...
    dashboard: {
      ...
      playground: {
        ...
        apis: { openaiResponses: 'OpenAI Responses', openaiResponsesLite: 'Responses Lite', openaiChatCompletions: 'OpenAI Chat Completions', anthropicMessages: 'Anthropic Messages' },
        responsesLiteHint: 'Uses Codex Responses Lite. Tool names, namespaces and image references are preserved; supported tools and image formats depend on the upstream model.',
      ...
      upstreamEditor: {
        ...
        models: {
          ...
          responsesTransport: 'OpenAI Responses transport',
          responsesStandard: 'Standard',
          responsesLite: 'Responses Lite',
          responsesTransportHint: 'Choose Responses Lite when the upstream model supports it. Keep Standard for other models.',
