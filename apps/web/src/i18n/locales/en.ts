  ...
  translation: {
    ...
    dashboard: {
      ...
      playground: {
        ...
        noKey: 'No API key',
        noKeyDescription: 'Create an API key before using the playground.',
        noKeyOption: 'No API Keys',
        noModel: 'No model selected',
        noModelForApi: 'No reachable model',
        noModelForApiDescription: 'No chat model on this gateway can serve the selected API.',
