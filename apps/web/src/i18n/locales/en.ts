    ...
    dashboard: {
      ...
      oauth2: {
        ...
        form: {
          ...
          accessPolicyHint: 'Optional JSON evaluated against the UserInfo response. contains requires the selected dotted-path claim to be an array containing the exact string. Leave blank to allow every authenticated user.',
        ...
        validation: {
          ...
          accessPolicyShape: 'Use logic and/or with conditions containing field, op contains, and a string value.',
        },
        toast: {
