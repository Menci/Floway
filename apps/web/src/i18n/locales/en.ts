  ...
  translation: {
    ...
    dashboard: {
      ...
      pages: {
        ...
        oauth2:
            'Configure external OAuth2 providers for self-service sign-in and account registration',
        backupRestore:
      ...
      oauth2: {
        empty: 'No OAuth2 providers configured. Add one to offer external sign-in.',
        callbackUnavailable: 'Set the public Base URL to generate this callback URL',
        accounts: {
          title: 'OAuth2 accounts',
          description: 'Bind another provider or remove identities you no longer use.',
          adminDescription: 'Remove OAuth2 identities bound to this user.',
          loading: 'Loading OAuth2 accounts',
          empty: 'No OAuth2 accounts are bound.',
          bind: 'Bind {{provider}}',
          bound: 'OAuth2 account bound',
          unlink: 'Unlink',
          unlinked: 'Unlinked {{provider}}',
          lastLogin: 'Set a password or bind another OAuth2 account before unlinking this last sign-in method.',
          unlinkTitle: 'Unlink OAuth2 account',
          unlinkMessage: 'Unlink {{provider}} account {{login}}? You will no longer be able to sign in with this identity.',
        },
        settings: {
          title: 'Public dashboard origin',
          description: 'The externally reachable origin Floway uses for OAuth2 callbacks and browser redirects',
          publicBaseUrl: 'Public Base URL',
          hint: 'Enter only the origin, without a path, query, or fragment. HTTP is supported for local development.',
          required: 'Providers remain hidden from the sign-in page until this URL is configured.',
          save: 'Save Base URL',
        },
        status: { enabled: 'Enabled', disabled: 'Disabled' },
        actions: {
          create: 'New OAuth2 provider',
          refresh: 'Refresh OAuth2 providers',
          save: 'Save provider',
          delete: 'Delete provider',
          editNamed: 'Edit OAuth2 provider {{name}}',
          deleteNamed: 'Delete OAuth2 provider {{name}}',
        },
        table: {
          label: 'OAuth2 login providers',
          name: 'Provider',
          id: 'Provider ID',
          status: 'Status',
        ...
        dialog: {
          createTitle: 'New OAuth2 provider',
          editTitle: 'Edit {{name}}',
        },
        form: {
          enabled: 'Enabled',
          enabledHint: 'Enabled providers appear on the sign-in page after the public Base URL is configured.',
          id: 'Provider ID',
          idHint: 'Letters, numbers, dash, or underscore. The ID becomes part of the callback URL and cannot be changed later.',
          displayName: 'Display name',
          clientId: 'Client ID',
          clientSecret: 'Client secret',
          clientSecretPreserved: 'Leave blank to keep the stored secret. Floway never sends the stored value back to the browser.',
          authorizationEndpoint: 'Authorization endpoint',
          tokenEndpoint: 'Token endpoint',
          userInfoEndpoint: 'UserInfo endpoint',
          accessPolicy: 'UserInfo access policy',
          accessPolicyHint: 'Optional JSON evaluated against the UserInfo response. Operators: eq, ne, gt, gte, lt, lte, in, not_in, contains, not_contains, exists and not_exists. Leave blank to allow every authenticated user.',
          accessPolicyPlaceholder: '{\n  "logic": "or",\n  "conditions": [\n    {\n      "field": "groups",\n      "op": "contains",\n      "value": "organization:team"\n    }\n  ]\n}',
          accessDeniedMessage: 'Access-denied message',
          accessDeniedMessageHint: 'Optional template shown when this policy rejects an account. Blank uses the Floway default. Variables: {{variables}}. current is the complete UserInfo object, so dotted paths can read individual claims.',
          registrationUpstreams: 'Self-registration upstream access',
          registrationUpstreamsHint: 'Assign a user-level upstream allowlist to future users who self-register with this provider. Selected upstreams are available and unselected upstreams are denied. Turn this off to allow all upstreams. Existing users are unchanged.',
          scopes: 'Scopes',
          scopesHint: 'Space-separated OAuth2 scopes, for example: openid profile email groups',
          clientAuthentication: 'Token endpoint authentication',
          userIdClaim: 'Stable user ID claim',
          usernameClaim: 'Suggested username claim',
          claimHint: 'Optional dotted JSON path. Leave blank to use Floway\'s standard claim fallbacks.',
          authorizationParams: 'Additional authorization parameters',
          authorizationParamsHint: 'A JSON object of string values. Protocol parameters such as state and redirect_uri are managed by Floway.',
        },
        ...
        validation: {
          ...
          id: 'Use 1-64 letters, numbers, dashes, or underscores.',
          maximum: 'This value is too long.',
          endpoint: 'Enter an absolute HTTP or HTTPS URL without credentials.',
          authorizationParamsJson: 'Enter valid JSON.',
          authorizationParamsShape: 'Enter a JSON object whose values are strings.',
          authorizationParamsReserved: 'Remove protocol parameters managed by Floway.',
          accessPolicyJson: 'Enter valid access-policy JSON.',
          accessPolicyShape: 'Use logic and/or with supported conditions. exists and not_exists omit value; in and not_in require an array; ordered comparisons require a number or string.',
        },
        toast: {
          settings: { pending: 'Saving the OAuth2 Base URL', success: 'Saved the OAuth2 Base URL' },
          create: { pending: 'Creating OAuth2 provider {{name}}', success: 'Created OAuth2 provider {{name}}' },
          edit: { pending: 'Saving OAuth2 provider {{name}}', success: 'Saved OAuth2 provider {{name}}' },
          delete: { pending: 'Deleting OAuth2 provider {{name}}', success: 'Deleted OAuth2 provider {{name}}' },
        },
        delete: {
          title: 'Delete OAuth2 provider',
          message: 'Delete {{name}}? Existing account bindings are retained, but users cannot sign in through this provider until the same provider ID is recreated.',
        },
      },
      upstreamAccess: {
      ...
      backupRestore: {
        ...
        import: {
          ...
          imported: {
            ...
            oauth2Providers_one: '{{count, number}} OAuth2 provider',
            oauth2Providers_other: '{{count, number}} OAuth2 providers',
