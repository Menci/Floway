  ...
  translation: {
    ...
    dashboard: {
      ...
      apiKeys: {
        ...
        agentSetup: {
          accessMethod: 'Connection method', setupTab: 'Setup script', snippetsTab: 'Config snippet', platform: 'Platform', modelSelection: 'Model selection', miscSettings: 'Miscellaneous settings', saving: 'Saving…', selectKey: 'Select an API key above to prepare a setup command.', preparing: 'Preparing setup…', noKey: 'Create an API key to use Agent Setup.', expired: 'This setup link has expired. Retry to create a fresh link.', retry: 'Retry', commandPending: '# Preparing setup command…', expires: 'The setup link stays alive while this page is visible and expires after you leave.', defaultModel: 'Default model', opusModel: 'Opus model', sonnetModel: 'Sonnet model', haikuModel: 'Haiku model', reasoningEffort: 'Reasoning effort', modelDefault: 'Default', noModelMatches: 'No matching models', modelDiscovery: 'Gateway model discovery', modelDiscoveryHint: 'Let Claude Code discover available models from this Floway gateway.', cleanupRetention: 'Cleanup retention', cleanupRetentionHint: 'Set how long Claude Code retains local session data before cleanup.', cleanupDays: '{{count}} days', optOutAiAttribution: 'Opt out of Claude Code AI attribution', optOutAiAttributionHint: 'Remove Claude Code attribution ("Co-Authored-By") from commits and pull requests, and hide session links.', unavailable: '{{id}} (unavailable)',
        },
        rotate: {
