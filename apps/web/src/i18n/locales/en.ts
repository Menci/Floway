    ...
    dashboard: {
      ...
      playground: {
        ...
        badges: {
          ...
          aliasOfPartial: 'Alias of <strong>{{reachable}}</strong> of <strong>{{total}}</strong> models',
          ...
          rules: {
            ...
            reasoningBudget: '<strong>{{value}}</strong> token budget',
            adaptive: 'Adaptive',
      ...
      upstreamEditor: {
        ...
        codex: {
          ...
          windowMinutes: '{{minutes}} min window',
          status: {
            active: 'Active',
        ...
        claudeCode: {
          ...
          source: { header: 'headers', probe: 'probe' },
          ...
          rawHeaders: 'Raw quota headers ({{count}})',
          rawProbe: 'Raw probe fields ({{count}})',
          stateUpdated: 'State updated {{time}}',
          tokenExpires: 'Access token expires {{time}}',
          probeFetched: 'Probe fetched {{time}}',
          status: {
            active: 'Active',
            heavy: 'Heavy usage ({{percent}}%)',
      ...
      modelAliases: {
        ...
        metadata: { heading: 'Announced metadata', description: 'Capabilities reported for this alias by /v1/models.', manual: 'Manual announced metadata', limits: 'Token limits', context: 'Context window', prompt: 'Prompt tokens', output: 'Output tokens', modalities: 'Modalities', imageInput: 'Image input', reasoning: 'Reasoning', effortEnabled: 'Effort levels', budgetEnabled: 'Budget tokens', adaptive: 'Adaptive', mandatory: 'Mandatory', efforts: 'Supported efforts', effortsHint: 'Comma-separated; order is preserved.', defaultEffort: 'Default effort', minBudget: 'Minimum budget', maxBudget: 'Maximum budget' },
