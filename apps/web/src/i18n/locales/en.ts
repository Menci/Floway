  ...
  translation: {
    ...
    dashboard: {
      ...
      modelAliases: {
        ...
        metadata: { heading: 'Announced metadata', description: 'Capabilities reported for this alias by /v1/models.', manual: 'Manual', limits: 'Token limits', context: 'Context window', prompt: 'Prompt tokens', output: 'Output tokens', modalities: 'Modalities', imageInput: 'Image input', reasoning: 'Reasoning', effortEnabled: 'Effort levels', budgetEnabled: 'Budget tokens', adaptive: 'Adaptive', mandatory: 'Mandatory', efforts: 'Supported efforts', effortsHint: 'Comma-separated; order is preserved.', defaultEffort: 'Default effort', minBudget: 'Minimum budget', maxBudget: 'Maximum budget' },
