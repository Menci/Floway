...
let cardMounts = 0;
vi.mock('../../../../src/components/keys/AgentSetupCard.vue', () => ({
...
const { default: KeysPage } = await import('../../../../src/pages/dashboard/keys/index.vue');
