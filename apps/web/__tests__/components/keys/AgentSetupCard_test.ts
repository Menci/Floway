...
vi.mock('../../../src/api/client.ts', () => ({ useApi: () => ({}) }));
vi.mock('../../../src/composables/useAgentSetup.ts', () => ({
...
const { default: AgentSetupCard } = await import('../../../src/components/keys/AgentSetupCard.vue');
