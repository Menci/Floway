...
const config: Linter.Config[] = [
  ...
  },
  {
    ...
    ignores: ['packages/gateway/src/shared/sse.ts'],
    rules: {
      'no-restricted-imports': ['error', {
        patterns: commonRestrictedImportPatterns,
        paths: [
          {
            ...
            message: 'Import streamSSE from packages/gateway/src/shared/sse.ts — the wrapper adds X-Accel-Buffering: no so SSE flows through nginx reverse proxies without buffering.',
          },
        ],
      }],
    },
